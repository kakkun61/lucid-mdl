...
checkbox_ :: Monad m => Lucid.HtmlT m () -> Text -> Maybe Ripple -> [Lucid.Attribute] -> [Lucid.Attribute] -> [Lucid.Attribute] -> Lucid.HtmlT m ()
checkbox_ label id' ripple checkboxAttributes inputAttributes labelAttributes =
...
radio_ :: Monad m => Lucid.HtmlT m () -> Text -> Text -> Maybe Ripple -> [Lucid.Attribute] -> [Lucid.Attribute] -> [Lucid.Attribute] -> Lucid.HtmlT m ()
radio_ label id' name ripple radioAttributes inputAttributes labelAttributes =
...
iconToggle_ :: Monad m => Lucid.HtmlT m () -> Text -> Maybe Ripple -> [Lucid.Attribute] -> [Lucid.Attribute] -> [Lucid.Attribute] -> Lucid.HtmlT m ()
iconToggle_ label id' ripple iconToggleAttributes inputAttributes labelAttributes =
